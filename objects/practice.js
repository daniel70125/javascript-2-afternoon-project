...
var user2 = {
  name: 'Billy Bob',
  email: 'bill.bob@devmounta.in',
  password: 'billy1',
  username: 'badbilly'
};
var user3 = {
  name: 'Lord Voldemort',
  email: 'lord.v@devmounta.in',
  password: 'Volde1',
  username: 'Lordv'
};
var user4 = {
  name: 'Luke Skywalker',
  email: 'luke.sky@devmounta.in',
  password: 'Skyw1',
  username: 'The Skywalker'
};
